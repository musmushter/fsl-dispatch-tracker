...
if not defined PYEXE for /f "tokens=*" %%P in ('where python 2^>nul') do if not defined PYEXE if /i not "%%P"=="%LOCALAPPDATA%\Microsoft\WindowsApps\python.exe" set "PYEXE=%%P"
